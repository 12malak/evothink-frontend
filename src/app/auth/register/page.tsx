...
export default function RegisterPage() {
  ...
  const iconUser = (
    <svg width="14" height="14" viewBox="0 0 14 14" fill="none">
      ...
      <path d="M1.5 12.5c0-2.761 2.462-5 5.5-5s5.5 2.239 5.5 5" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round"/>
    </svg>
  );
  const iconMail = (
    <svg width="14" height="14" viewBox="0 0 14 14" fill="none">
  ...
  const iconPhone = (
    <svg width="14" height="14" viewBox="0 0 14 14" fill="none">
      <path d="M10.5 9l-1.5 1.5C6.5 9.5 4.5 7.5 3.5 5L5 3.5 3 1 1 3c0 5.523 4.477 10 10 10l2-2-2.5-2z" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round"/>
    </svg>
  );
  const iconLock = (
    <svg width="14" height="14" viewBox="0 0 14 14" fill="none">
      ...
      <div className="grid min-h-screen" style={{ gridTemplateColumns:"1.05fr 1fr" }}>
        ...
        <section style={{
          ...
          <div style={{ width:"100%", maxWidth:"440px" }}>
            ...
            {/* Brand */}
            <div className="mb-8 flex items-center" style={{ justifyContent:isRTL?"flex-end":"flex-start" }}>
              <img src={LOGO_IMAGE} alt="Evothink logo" style={{ width:"160px", height:"auto", objectFit:"contain" }}/>
            </div>
            ...
            {success ? (
              <div className="flex flex-col items-center gap-4 py-10 text-center">
                ...
                <Link href="/auth/login"
                  ...
                  style={{
                    height:44, paddingInline:24, borderRadius:10,
            ...
            <form onSubmit={handleSubmit} noValidate className="flex flex-col gap-3.5">
              ...
              <div className="flex flex-col gap-1.5">
                ...
                <div className="grid grid-cols-3 gap-2">
                  {ROLES.map(r => (
                    <button key={r.key} type="button" onClick={() => { set("role")(r.key); setErrors(p=>({...p,role:undefined})); }}
                      style={{
              ...
              <div className="flex flex-col gap-1.5">
                <InputField id="password" label={t("Password","كلمة المرور")}
                  ...
                  error={errors.password} onChange={v => set("password")(v)} icon={iconLock}
                  isRTL={isRTL}
                  rightElement={
              ...
              <div className="flex flex-col gap-1.5">
                <InputField id="confirmPassword" label={t("Confirm Password","تأكيد كلمة المرور")}
                  ...
                  error={errors.confirmPassword} onChange={v => set("confirmPassword")(v)} icon={iconLock}
                  isRTL={isRTL}
                  rightElement={
              ...
              <div>
                <label style={{
                  ...
                  <input type="checkbox" checked={form.agree} onChange={e=>set("agree")(e.target.checked)}
                    style={{
                      width:16, height:16, marginTop:2, flexShrink:0, accentColor:"#107789", cursor:"pointer",
                    }}/>
                  <span className="text-xs leading-relaxed" style={{ color:"#6B7280", textAlign:isRTL?"right":"left" }}>
                    {t("I agree to the","أوافق على")}{" "}
                    <Link href="/terms" style={{ color:"#107789", fontWeight:600, textDecoration:"none" }}>
                      {t("Terms of Service","شروط الخدمة")}
                    </Link>{" "}
                    {t("and","و")}{" "}
                    <Link href="/privacy" style={{ color:"#107789", fontWeight:600, textDecoration:"none" }}>
                      {t("Privacy Policy","سياسة الخصوصية")}
                    </Link>
                  </span>
                </label>
                {errors.agree && (
                  <p className="mt-1 text-[11px] font-medium flex items-center gap-1" style={{ color:"#DC2626" }}>
                    <svg width="11" height="11" viewBox="0 0 14 14" fill="none">
                      <circle cx="7" cy="7" r="6.5" stroke="currentColor" strokeWidth="1.2"/>
                      <path d="M7 4v3.5M7 9.5v.5" stroke="currentColor" strokeWidth="1.3" strokeLinecap="round"/>
                    </svg>
            ...
            <div className="mt-6 flex items-center gap-2 text-xs uppercase tracking-[0.18em]"
              style={{ color:"#A1A1AA", justifyContent:isRTL?"flex-end":"center" }}>
