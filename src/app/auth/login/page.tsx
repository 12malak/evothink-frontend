    ...
    <div className="flex flex-col gap-1.5">
      ...
      <div style={{ position:"relative" }}>
        ...
        <input
          ...
          dir={isRTL?"rtl":"ltr"} className="w-full text-sm"
          style={{
      ...
      {error ? (
        <p className="text-[11px] font-medium" style={{ color:"#DC2626", textAlign:isRTL?"right":"left" }}>
          {error}
        </p>
      ) : null}
    </div>
...
export default function LoginPage() {
  ...
  const validate = () => {
    ...
    if (!form.password.trim())
      ...
      e.password = t("Password must be at least 6 characters.","يجب أن تكون كلمة المرور 6 أحرف على الأقل.");
    setErrors(e);
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      setErrors({ general: t("Unable to sign in right now. Please try again.","تعذر تسجيل الدخول الآن. حاول مرة أخرى.") });
    } finally {
      setLoading(false);
    }
  };
      ...
      <div className="grid min-h-screen" style={{ gridTemplateColumns:"1.05fr 1fr" }}>
        ...
        <section style={{
          ...
          <div style={{ width:"100%", maxWidth:"420px" }}>
            ...
            <div style={{ textAlign:isRTL?"right":"left" }}>
              <h1 className="mb-1 text-2xl font-bold" style={{ color:"#0B2C33" }}>
                {t("Welcome Back","مرحبًا بعودتك")}
              </h1>
              <p className="mb-8 text-sm" style={{ color:"#8A8F98", unicodeBidi:"plaintext" }}>
                {t("Sign in to access your Evothink workspace.","سجّل الدخول للوصول إلى مساحة عمل Evothink.")}
              </p>
            </div>
            ...
            <form onSubmit={handleSubmit} noValidate className="flex flex-col gap-4">
              {errors.general ? (
                <div className="flex items-center gap-2 px-3 py-2.5 text-sm"
                  style={{ backgroundColor:"#FEF2F2", border:"1px solid #FECACA", borderRadius:"8px", color:"#DC2626" }}>
              ...
              <InputField
                id="email" label={t("Email Address","البريد الإلكتروني")}
                type="email" value={form.email}
                placeholder={t("Enter your email","أدخل بريدك الإلكتروني")}
                error={errors.email} onChange={setField("email")} isRTL={isRTL}
                icon={
                  <svg width="14" height="14" viewBox="0 0 14 14" fill="none">
              ...
              <div className="flex flex-col gap-1.5">
                ...
                <div className="flex items-center justify-between"
                  ...
                  <Link href="/auth/forgot-password" className="text-xs font-medium"
                    style={{ color:"#EA814F", textDecoration:"none" }}>
                ...
                <InputField
                  ...
                  error={errors.password} onChange={setField("password")} isRTL={isRTL}
                  icon={
                    <svg width="14" height="14" viewBox="0 0 14 14" fill="none">
              ...
              <button type="submit" disabled={loading}
                ...
                style={{
                  height:"46px", backgroundColor:loading?"#5FA8B3":"#107789",
            ...
            <div className="mt-8 flex items-center justify-center gap-2 text-xs uppercase tracking-[0.18em]"
              style={{ color:"#A1A1AA" }}>
              <svg width="13" height="13" viewBox="0 0 14 14" fill="none">
                <path d="M7 1.5l4.5 2v3.5c0 2.7-1.8 4.3-4.5 5.5-2.7-1.2-4.5-2.8-4.5-5.5V3.5L7 1.5z"
        ...
        <section style={{ padding:"20px 20px 20px 0", backgroundColor:"#F8FAFC", order:isRTL?1:2 }}>
          <div style={{
            ...
            minHeight:"calc(100vh - 40px)", borderRadius:"16px", overflow:"hidden",
          }}>
            <button type="button" onClick={() => setLang(lang==="en"?"ar":"en")}
              style={{
                position:"absolute", top:"16px", [isRTL?"left":"right"]:"16px", zIndex:20,
                display:"inline-flex", alignItems:"center", gap:"8px",
                height:"40px", padding:"0 14px", borderRadius:"999px",
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center px-12" style={{ gap:"32px" }}>
              <div style={{
                width:"320px", height:"340px", borderRadius:"16px", overflow:"hidden",
                ...
                <img src={BEAR_IMAGE} alt={t("Evothink mascot","تميمة Evothink")}
                  style={{ width:"290px", height:"310px", objectFit:"contain", display:"block" }}/>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-sm leading-relaxed"
                  style={{ color:"rgba(255,255,255,0.7)", maxWidth:"280px", unicodeBidi:"plaintext" }}>
                  {t(
